...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081469062947147-wm)
...
这就是子进程产生的由来。简单的实现逻辑就如下方所示[【注释１】](#jump)
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081469027998669-wm)
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081468836854017-wm)

或者从此图我们可以更加形象的看清子父进程的关系

![实验楼](https://dn-simplecloud.shiyanlou.com/1135081469030455439-wm)
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081469036077882-wm)

图中所显示的 `[1] 236`分别是该 job 的 job number 与该进程的 PID，而最后一行的 Done 表示该命令已经在后台执行完毕。

我们还可以通过 `ctrl + z` 使我们的当前工作停止并丢到后台中去

![实验楼](https://dn-simplecloud.shiyanlou.com/1135081469036715105-wm)
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081469037666320-wm)
