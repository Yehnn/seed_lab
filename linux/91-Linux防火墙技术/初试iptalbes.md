...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081470275501751-wm)

NAT 分为三种类型

- 静态NAT（static NAT）：ip 地址在转换时是一种一对一的关系
- 动态NAT（dynamic NAT 或者叫 pooled NAT）： ip 地址在转换时是一种多对多的关系
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081470275837511-wm)
...
3. 本地相应的程序若是做出相应，产生新的数据包往外发送，数据包将进入到 OUTPUT 链，而在 OUTPUT 链中与 INPUT 链匹配表的顺序相同，依旧是首先查看 raw 表，然后查看 mangle 表，查看 NAT表 ，最后查看 filter 表，若是该数据包还能继续前进将会被发送到 POSTROUTING 链中。
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081470273754769-wm)
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081470273935225-wm)
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081470276058332-wm)
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081470276498200-wm)
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081470277657578-wm)
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081470278205181-wm)
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081470278781199-wm)
...
| -I           | 表示我们制定位置插入当前的这个规则，insert，指定的位置写在链后面 ，若是没有制定则默认值为1，也就是将该规则添加在指定表的指定链的第一位 |
...
![实验楼](https://dn-simplecloud.shiyanlou.com/1135081470281002382-wm)
