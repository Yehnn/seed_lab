...
![此处输入图片的描述](https://doc.shiyanlou.com/document-uid8797labid787timestamp1526959592678.png)
...
```bash
$ wget http://www.cis.syr.edu/\~wedu/seed/Labs_12.04/Crypto/Crypto_Encryption/files/pic_original.bmp
...
![此处输入图片的描述](https://doc.shiyanlou.com/document-uid8797labid787timestamp1526959590970.png)

把 pic_ecb.bmp 和 pic_cbc.bmp 的文件头修改成 pic_original.bmp 的文件头（可复制粘贴）。

修改加密后文件的文件头

![](https://doc.shiyanlou.com/md0417787ssMTTDx.png/wm)

![此处输入图片的描述](https://doc.shiyanlou.com/document-uid8797labid787timestamp1526959591420.png)

![此处输入图片的描述](https://doc.shiyanlou.com/document-uid8797labid787timestamp1526959591812.png)

2. 修改完后，打开图片，描述你的观察结果。

![此处输入图片的描述](https://doc.shiyanlou.com/document-uid8797labid787timestamp1526960070856.png/wm)
...
![此处输入图片的描述](https://doc.shiyanlou.com/document-uid8797labid787timestamp1527059152199.png)

**3、接下来我们模拟密文损坏的情况**

找到密文文件右击，选择用其他程序打开，再点击 Bless Hex Editor -》打开。

![此处输入图片的描述](https://doc.shiyanlou.com/document-uid8797labid787timestamp1527059478277.png)

原始的文件中第 30 位是 EA，我们将其改为 FA，以制造损坏的密文。

原始：

![此处输入图片的描述](https://doc.shiyanlou.com/document-uid8797labid787timestamp1527060361547.png)

修改后：

![此处输入图片的描述](https://doc.shiyanlou.com/document-uid8797labid787timestamp1527060332072.png)
...
![此处输入图片的描述](https://doc.shiyanlou.com/document-uid8797labid787timestamp1527060793229.png)
...
![此处输入图片的描述](https://doc.shiyanlou.com/document-uid8797labid787timestamp1527061830341.png)
...
- name: check size
  script: |
    #!/bin/bash
    ls -l test20.txt|awk '{print $5}'|grep 20
