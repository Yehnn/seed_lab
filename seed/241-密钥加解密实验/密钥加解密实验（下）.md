...
##三、实验内容
本节将通过实践操作，带领大家使用 Openssl 加密库进行编程以及生成伪随机数。

###3.1 使用 Openssl 加密库进行编程
...
> Note :  如果你打算将明文存储在文件中读取，一些编辑器可能会擅自加奇怪的东西进去，比如 windows 的记事本，使用实验楼环境的编辑器不会有这样的顾虑。
...
![2-3.1-1](https://doc.shiyanlou.com/document-uid8797labid788timestamp1527046187365.png)
