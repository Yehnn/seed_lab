...
![3.1-1](https://doc.shiyanlou.com/document-uid600404labid749timestamp1527225844103.png/wm)
...
- name: check stack.c
  script: |
    #!/bin/bash
    ls /tmp/stack.c
  error: /tmp 目录下没有 stack.c
- name: check stack
  script: |
    #!/bin/bash
    ls /tmp/stack
    stat -c %a /tmp/stack |grep 4755
  error: 没有编译 stack.c 或者权限不对
- name: check owner
  script: |
    #!/bin/bash
    stat -c %U /tmp/stack |grep root
...
![3.4-1](https://doc.shiyanlou.com/document-uid8797labid749timestamp1526460390989.png/wm)

接下来的操作：

![3.4-2](https://doc.shiyanlou.com/document-uid8797labid749timestamp1526460749835.png/wm)
...
![3.5-1](https://doc.shiyanlou.com/document-uid8797labid749timestamp1527214591711.png/wm)
